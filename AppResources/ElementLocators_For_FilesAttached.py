INPUT_FILE_PATH = "../AppResources/InputFile_For_FilesAttached.xlsx"
...
search_selcetor = "//span[@class='sps-select__value'][contains(text(), 'IN')]"
...
retailer_names_path = "//td[4]/a[@title='Organization Details' and @style='text-decoration: none;']"
...
#A And R Metal Industries Ltd - Paccar Parts 850
#Lakanto
